{{config(materialized='semantic_view', alias='sv_products')}}

tables (
    {{ ref('products') }} comment='The table contains records of customers and their purchasing history. Each record represents a single customer and includes details about their order activity over time, total spending amounts, and customer classification.'
)
facts (
